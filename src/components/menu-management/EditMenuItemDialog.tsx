    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-4xl bg-card border-border">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4 min-h-[490px]">
            {dialogLoading ? (
              <div className="md:col-span-2 flex justify-center items-center">
                <Loader2 className="h-8 w-8 text-cyan-400 animate-spin" />
              </div>
            ) : dialogError ? (
              <div className="md:col-span-2 flex flex-col justify-center items-center text-destructive">
          ...
          <DialogFooter className="mt-4 sm:justify-end">
            <div className="flex w-full justify-end gap-2">
              ...
              <AlertDialogTrigger asChild>
                  <Button type="button" variant="ghost" className="bg-purple-500/20 text-purple-300 hover:bg-purple-500/30 hover:text-purple-300">
                      Delete Item
                  </Button>
              </AlertDialogTrigger>
              <AlertDialogContent>
              ...
              <Button
                type="submit"
                className="bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 min-w-[120px]"
