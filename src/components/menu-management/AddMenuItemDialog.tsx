      ...
      <DialogContent className="sm:max-w-4xl bg-card border-border">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <DialogFooter className="mt-6">
            <Button
                type="submit"
                className="bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 min-w-[100px]"
             ...
             return (
                <div key={field.id} className="flex items-center justify-between p-2 rounded-md bg-card">
                  ...
                  <div className="flex items-center gap-2">
                      ...
                      />
                      <Button size="icon" className="h-6 w-6 bg-purple-500/20 text-purple-300 hover:bg-purple-500/30" onClick={() => remove(index)}>
